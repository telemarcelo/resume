var bio = {
	...
	"welcomeMessage": "   Dedicated CS/Math Teacher with a strong desire to communicate the beauty and importance of the new literacy.<BR>   An amateur artist and musician who would like to use these skills as a vehicle for teaching technology.<BR>",
	"biopic" : "images/portrait-small.jpg",
	"skills" : ['Teaching','Programming','Web Design', 'Game Design','Risk Management',
	,'Portuguese', 'Soccer Coaching']
};
...
var education = {
	...
	"online": [{
		"title": "Udacity",
		"School": "Udacity",
		"dates": "Nanodegree: 300hrs, currently enrolled",
...
var work = {
	"jobs":[{
		...
		"description" : "Risk Reporting: tasks included S&P Capital Modeling, Municipal Contract cash flow projections, liquidity modeling, and other project and risk reports.  Valuation Area: Tasks included Cash Flow Testing, Embedded Value, and Loss Recognition. Numerous other projects to expand business and protect firm’s capital."
	}]}
