var bio = {
    ...
    "skills": ['Teaching', 'Programming', 'Web Design', 'Game Design', 'Risk Management', , 'Languages', 'Soccer Coaching']
};
...
bio.display = function() {
    ...
    formattedMessage = HTMLwelcomeMsg.replace("%data%", bio.welcomeMessage_2);
    $('#header').append("<p></p>" + formattedMessage);
